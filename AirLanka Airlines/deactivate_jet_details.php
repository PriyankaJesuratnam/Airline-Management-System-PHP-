...
<link rel="stylesheet" type="text/css" href="https://s3-us-west-2.amazonaws.com/s.cdpn.io/326786/dc-element.nav-menu.css" />
		...
		<div class="bg-img2">	
	   <h3>FLIGHT TO BE DEACTIVATED</h3>
		
		
		<center><form action="deactivate_jet_details_form_handler.php" class="container1" method="post" >
		<center><h4>AIRLANKA AIRLINES</h4></center><br><br>	
			...
			<table cellpadding="5" style="padding-left: 20px;">
				<tr>
					<td class="fix_table">ENTER VALID FLIGHT ID</td>
				</tr>
				<tr>
