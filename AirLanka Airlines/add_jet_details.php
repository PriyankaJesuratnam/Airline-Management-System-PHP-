...
<link rel="stylesheet" type="text/css" href="https://s3-us-west-2.amazonaws.com/s.cdpn.io/326786/dc-element.nav-menu.css" />
	...
	<center><form action="add_jet_details_form_handler.php" class="container1" method="POST">
		<?php
				if(isset($_GET['msg']) && $_GET['msg']=='success')
				{
					echo "<strong style='color: green'>The Flight has been successfully added.</strong>
						<br><br>";
				}
				else if(isset($_GET['msg']) && $_GET['msg']=='failed')
				{
					echo "<strong style='color:red'>*Flight ID already exists, please enter a new FLIGHT ID.</strong>
						<br><br>";
				}
			?>
    <center><h4>AIRLANKA AIRLINES</h4></center><br><br>
		
	<label for="FLIGHT ID"><b>ENTER A VALID FLIGHT ID</b></label><br><br>
    <input type="text" placeholder="ENTER FLIGHT ID" name="jet_id" required><br>
		
	<label for="FLIGHT TYPE"><b>ENTER THE FLIGHT TYPE/MODEL</b></label><br><br>
    <input type="text" placeholder="ENTER FLIGHT TYPE" name="jet_type" required><br>

    <label for="date"><b>TOTAL CAPACITY OF THE FLIGHT</b></label><br><br>
    <input type="number" name="jet_capacity" required><br><br>
