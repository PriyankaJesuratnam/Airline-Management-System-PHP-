...
<link rel="stylesheet" type="text/css" href="https://s3-us-west-2.amazonaws.com/s.cdpn.io/326786/dc-element.nav-menu.css" />
		...
		<div class="bg-img2"> 
		<h3>PRINT YOUR TICKETS</h3>
			
   	<center><form action="pnr.php" class="container1" method="POST">
    <center><h4>AIRLANKA AIRLINES</h4></center>
	
	<center><img src="images/Photo_1660199509947.png" width="180px" height="150px" ></center>
	<label for="pnr" id="u_id"><b>ENTER YOUR PNR</b></label><br><br>
    <input type="text" placeholder="ENTER YOUR PNR" name="pnr" required><br>
    		
	<button type="submit" id="u_sub" name="u_sub" value="Submit" class="btn">PRINT</button><br><br>
		
	<button type="submit" name="Submit" value="Submit" onclick="location.href = './customer_homepage.php';" class="toggle btn btn-primary">BACK TO PORTAL</button>	
	</div>	
	</form></center>
