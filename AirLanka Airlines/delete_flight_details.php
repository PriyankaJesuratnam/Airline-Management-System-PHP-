...
<link rel="stylesheet" type="text/css" href="https://s3-us-west-2.amazonaws.com/s.cdpn.io/326786/dc-element.nav-menu.css" />
	...
	<div class="bg-img2">	
	<h3>ENTER THE FLIGHT SCHEDULE TO BE DELETED</h3>	
		<div>
			<?php
	...
	<label for="FLIGHT NO"><b>ENTER THE VALID FLIGHT NO</b></label><br><br>
	...
	<button type="submit" name="Delete" value="Delete" class="btn">DELETE</button><br><br>
	</div>	
	</form></center>
