...
<div id="wrapper">
    ...
    <div class="left-section">
        <ul class="nav">
           <li><i class="fa fa-plane" aria-hidden="true"></i><a href="admin_view_booked_tickets.php" class="menu-item"><span class="fontawesome-home ftm"></span>Booked Tickets</a>
            </li>
            <!-- <li><a href="#" class="menu-item"><span class="fontawesome-home font-awesome-margin"></span>About <span class="arrow">»</span></a> --></li>
            <li><i class="fa fa-plane" aria-hidden="true"></i><a href="add_flight_details.php" class="menu-item"><span class="fontawesome-user ftm"></span>Add Schedule</a>

            </li>
            <li><i class="fa fa-plane" aria-hidden="true"></i><a href="delete_flight_details.php" class="menu-item"><span class="fontawesome-cog ftm"></span>Delete Schedule</a>

            </li>
            <li><i class="fa fa-plane" aria-hidden="true"></i><a href="add_jet_details.php" class="menu-item"><span class="fontawesome-envelope-alt ftm"></span>Add Flight Details</a>

            </li>
            <li><i class="fa fa-plane" aria-hidden="true"></i><a href="activate_jet_details.php" class="menu-item"><span class="fontawesome-heart ftm"></span>Activate Flight</a>

            </li>
            <li><i class="fa fa-plane" aria-hidden="true"></i><a href="deactivate_jet_details.php" class="menu-item"><span class="fontawesome-list ftm"></span>Deactivate Flight</a>
    ...
    <div class="right-section">
		       <h3 id="name">WELCOME TO ADMINISTRATOR</h3>
            </div>
            </div>
        </div>
    </body>
